...
[![Tests](https://github.com/bleedingdeacons/unity/actions/workflows/ci.yml/badge.svg)](https://github.com/bleedingdeacons/unity/actions/workflows/ci.yml)
...
- **Brain Monkey** for WordPress function and hook mocking, replacing WP_Mock —
  whose own `require` pinned this suite to PHPUnit 9.6
...
All public APIs must be defined by interfaces. PHPStan compliance at the level set in `phpstan.neon.dist` is required.
